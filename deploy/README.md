...
Важно: для общих статических файлов и медиа используйте путь вне `/root`, например `/var/www/hd_realty/...`, потому что nginx-процесс не может читать файлы из `/root`.
